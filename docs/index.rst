...
awsmp is a module and CLI tool that can be used to interact with the `AWS Marketplace API`_
...
..  grid:: 1 1 1 1
   ...
   ..  grid-item:: :doc:`Installation <installation>`

      **Instructions** covering how to setup and install awsmp
