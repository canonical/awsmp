...
class TestEntity:
                ...
                models.DiffModel(
                    ...
                    changed=[
                        models.DiffChangedModel(
                            ...
                            old_value=[{"Text": "test-link", "Url": HttpUrl("https://test-url")}],
                            new_value=[{"Text": "test-link1", "Url": HttpUrl("https://test-url")}],
                        )
                    ],
                ),
            ),
            ...
            (
                ...
                models.DiffModel(
                    ...
                    changed=[
                        models.DiffChangedModel(
                            name="SupportTerm",
                            old_value="test_refund_policy_term\n",
                            new_value="test",
                        )
                    ],
                ),
    ...
    def test_get_support_term_diff(self, mock_boto3, get_entity, custom_config, expected_diff):
        entity1, entity2 = get_entity
        for key, value in custom_config.items():
            setattr(entity2, key, value)
        assert entity1.get_diff(entity2) == expected_diff
